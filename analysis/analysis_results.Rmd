...
# temporary check of how much we match 
...
DF_Second_match$easy_screen[is.na(DF_Second_match$easy_screen)] <- TRUE

table(DF_Second_match$easy_screen, 
...
jifDF$JIFYear[ 
  is.na(jifDF$JIFYear) & jifDF$JIF != "NO ACCESS" & !is.na(jifDF$JIF)
  ] <- jifDF$Year[
    is.na(jifDF$JIFYear) & jifDF$JIF != "NO ACCESS" & !is.na(jifDF$JIF)
  ]

# fix this issue
jifDF$JIF[jifDF$JIF == "1105.0"] <- "1.105"

# number of no access
table(jifDF$JIF_no)

# describe jif
describeBy(as.numeric(jifDF$JIF), group = jifDF$year_split)
