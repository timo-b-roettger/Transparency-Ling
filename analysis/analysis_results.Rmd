...
###### check the empirical study data to make sure if it should be NA or the answer ##### 
###### make coder document for resolving false and unclear matches #####
...
DF_fix <- DF_Second_match_agree %>% filter(!is.na(corrected_answer))
...
###### do we want to exclude everything or only include matches ######

```{r}
# decide if we want to filter 
